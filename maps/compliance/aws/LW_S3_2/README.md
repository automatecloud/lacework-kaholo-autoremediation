...
5. The Variable **Recommendation ID** needs to be configured with Value **LW_S3_2**.
...
This configuration will make sure that this map is only triggered if the **rec_id** of the [Webhook payload](https://support.lacework.com/hc/en-us/articles/360034367393-Webhook) is equal to the **LW_S3_2** Event ID.
...
```
{
    ...
    "suppressionuuid": "d845961d-2a10-4aa2-9daf-d978a6d25c67"
}
```
