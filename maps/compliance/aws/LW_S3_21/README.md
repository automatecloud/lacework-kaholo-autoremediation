# AutoRemediation for the Lacework Policy LW_S3_21

## Description
Ensure the attached S3 bucket policy does not grant global 'Put' permission

The S3 Bucket policy gives 'Allow' for global 'Put' permission to everyone. It is best practice to
...
```
{
    ...
    "rec_id": "LW_S3_21",
    "violationdescription": "Ensure the attached S3 bucket policy does not grant global Put permission.",
    "eventuuid": "4e0e61f3-3888-4937-b8d9-2d956142a1fa",
    "reportuuid": "a12f0459-5fae-465e-a138-29f99c2af67b",
    ...
    "suppressionuuid": "33aae293-6d46-4d6f-9843-cca8ea5b7037",
    "createbackup": "true",
...
The Map Version 1.2 (8th of September 2021) supports the following additional features on top of the Map Version  1.1:
