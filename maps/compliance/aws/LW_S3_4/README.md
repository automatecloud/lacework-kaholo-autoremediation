...
export EVENTDESCRIPTION="AWS Account 112233445566 (lacework-test) : LW_S3_4 LW_S3_4 Ensure the S3 bucket ACL does not grant 'Everyone' WRITE_ACP permission [modify bucket ACL]"
```
