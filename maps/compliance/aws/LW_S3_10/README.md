...
1. Create a test S3 bucket that is violating the compliance rule for **LW_S3_10** via the CLI command described in the section [How can i use the Map?](https://github.com/automatecloud/lacework-kaholo-autoremediation/tree/main/maps/compliance/aws/LW_S3_10#how-can-i-use-this-map-for-auto-remediation)
