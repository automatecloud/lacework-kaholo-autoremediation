# AutoRemediation for the Lacework Policy AWS_CIS_1_13
...
managed to be kept charged and secured independent of any individual personal
...
The **AWS_CIS_1_13** map currently has the following map design:

<img src="AWS_CIS_1_13.png">

### Map trigger

Make sure that the Map Webhook Trigger is configured with the following configuration:

<img src="AWS_CIS_1_13_Trigger.png" width="269" height="608">
...
5. The Variable **Recommendation ID** needs to be configured with Value **AWS_CIS_1_13**.
...
This configuration will make sure that this map is only triggered if the **rec_id** of the [Webhook payload](https://support.lacework.com/hc/en-us/articles/360034367393-Webhook) is equal to the **AWS_CIS_1_13** Event ID.
