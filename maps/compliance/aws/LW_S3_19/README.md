# AutoRemediation for the Lacework Policy LW_S3_19

## Description
Ensure the attached S3 bucket policy does not grant global 'Delete' permission

The S3 Bucket policy gives 'Allow' for global 'Delete' permission to everyone. It is best practice to
...
8. To limit permissions to specific actions, replace global 'Delete' actions with specific 'Delete'
actions
...
The **LW_S3_19** map currently has the following map design:

<img src="LW_S3_19.png">
...
<img src="LW_S3_19_Trigger.png" width="361" height="810">
...
5. The Variable **Recommendation ID** needs to be configured with Value **LW_S3_19**.
...
This configuration will make sure that this map is only triggered if the **rec_id** of the [Webhook payload](https://support.lacework.com/hc/en-us/articles/360034367393-Webhook) is equal to the **LW_S3_19** Event ID.
...
```
{
    ...
    "rec_id": "LW_S3_19",
    "violationdescription": "Ensure the attached S3 bucket policy does not grant global Delete permission.",
    "eventuuid": "e111926e-8e1c-4e5d-b46a-ff1c06271183",
    "reportuuid": "d61ff236-d32b-4ea1-bf97-f35f3a3c7349",
    ...
    "suppressionuuid": "b70dbc06-a846-449d-8009-e4f3db066448",
    "createbackup": "true",
...
1. Create a test S3 bucket that is violating the compliance rule for **LW_S3_19** via the CLI command described in the section [How can i use the Map?](https://github.com/automatecloud/lacework-kaholo-autoremediation/tree/main/maps/compliance/aws/LW_S3_19#how-can-i-use-this-map-for-auto-remediation)
...
export EVENTDESCRIPTION="AWS Account 112233445566 (lacework-test) : LW_S3_19 Ensure the attached S3 bucket policy does not grant 'Delete' permission to everyone"
export REC_ID=LW_S3_19
```
