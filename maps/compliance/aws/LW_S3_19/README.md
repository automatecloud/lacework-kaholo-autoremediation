...
<img src="LW_S3_19.png" width="678" height="477">
...
<img src="LW_S3_19_Trigger.png" width="322" height="712">
...
This configuration will make sure that this map is only triggered if the **event_description** of the [Webhook payload](https://support.lacework.com/hc/en-us/articles/360034367393-Webhook) includes the **LW_S3_19** Event ID.
...
```
{
    ...
    "policyID": "LW_S3_19",
    "violationdescription": "Ensure the attached S3 bucket policy does not grant Delete permission to everyone",
...
<img src="geteventdetails2.png" width="282" height="219">
