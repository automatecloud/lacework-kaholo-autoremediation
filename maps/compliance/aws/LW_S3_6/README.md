...
5. The Variable **Recommendation ID** needs to be configured with Value **LW_S3_6**.
...
This configuration will make sure that this map is only triggered if the **rec_id** of the [Webhook payload](https://support.lacework.com/hc/en-us/articles/360034367393-Webhook) is equal to the **LW_S3_6** Event ID.
...
```
{
    ...
    "suppressionuuid": "d4bc2ad7-29a3-4964-aefc-18023359e631"
}
```
...
1. Create an test S3 bucket that is violating the compliance rule for **LW_S3_6** via the CLI command described in the section [How can i use the Map?](https://github.com/automatecloud/lacework-kaholo-autoremediation/tree/main/maps/compliance/aws/LW_S3_6#how-can-i-use-this-map-for-auto-remediation)
