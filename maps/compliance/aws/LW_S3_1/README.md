...
export EVENTDESCRIPTION="AWS Account 112233445566 (lacework-test) : LW_S3_1 Ensure the S3 bucket ACL does not grant Everyone READ permission [create, overwrite, and delete S3 objects]"
```
