# AutoRemediation for the Lacework Policy AWS_CIS_1_15

## Description
Ensure security questions are registered in the AWS account (Not
Scored)
...
40 | P a g e
o Click on the Answer section
o Enter an appropriate answer
...
This map can be used to trigger a auto remediation for adding the necessary security questions and answers.
...
The **AWS_CIS_1_15** map currently has the following map design:

<img src="AWS_CIS_1_15.png">

### Map trigger

Make sure that the Map Webhook Trigger is configured with the following configuration:

<img src="AWS_CIS_1_15_Trigger.png" width="269" height="608">
...
5. The Variable **Recommendation ID** needs to be configured with Value **AWS_CIS_1_15**.
...
This configuration will make sure that this map is only triggered if the **rec_id** of the [Webhook payload](https://support.lacework.com/hc/en-us/articles/360034367393-Webhook) is equal to the **AWS_CIS_1_15** Event ID.
...
```
{
    ...
    "rec_id": "AWS_CIS_1_15",
    "violationdescription": "Ensure security questions are registered in the AWS account",
...
```
echo echo aws adding security questions
```
...
export EVENTDESCRIPTION="AWS Account 112233445566 (lacework-test) : AWS_CIS_1_15 Ensure security questions are registered in the AWS account (Not Scored)
export REC_ID=AWS_CIS_1_15
```
