...
The **AWS_CIS_1_9** map currently has the following map design:

<img src="AWS_CIS_1_9.png">

### Map trigger

Make sure that the Map Webhook Trigger is configured with the following configuration:

<img src="AWS_CIS_1_9_Trigger.png" width="269" height="608">
...
5. The Variable **Recommendation ID** needs to be configured with Value **AWS_CIS_1_9**.
...
This configuration will make sure that this map is only triggered if the **rec_id** of the [Webhook payload](https://support.lacework.com/hc/en-us/articles/360034367393-Webhook) is equal to the **AWS_CIS_1_9** Event ID.
...
```
{
    ...
    "rec_id": "AWS_CIS_1_9",
    "violationdescription": "Ensure IAM password policy requires minimum length of 14 or
    greater",
...
export EVENTDESCRIPTION="AWS Account 112233445566 (lacework-test) : AWS_CIS_1_9 Ensure IAM password policy requires minimum length of 14 or greater
export REC_ID=AWS_CIS_1_9
```
