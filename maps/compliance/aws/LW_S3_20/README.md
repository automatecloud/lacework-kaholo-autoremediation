...
5. The Variable **Recommendation ID** needs to be configured with Value **LW_S3_21**.
...
This configuration will make sure that this map is only triggered if the **rec_id** of the [Webhook payload](https://support.lacework.com/hc/en-us/articles/360034367393-Webhook) is equal to the **LW_S3_21** Event ID.
...
The Map Version 1.2 (15th of September 2021) supports the following additional features on top of the Map Version  1.1:
