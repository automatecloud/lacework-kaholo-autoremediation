# AutoRemediation for the Lacework Policy LW_S3_20
...
The **LW_S3_20** map currently has the following map design:

<img src="LW_S3_20.png">
...
5. The Variable **Recommendation ID** needs to be configured with Value **LW_S3_20**.
...
This configuration will make sure that this map is only triggered if the **rec_id** of the [Webhook payload](https://support.lacework.com/hc/en-us/articles/360034367393-Webhook) is equal to the **LW_S3_20** Event ID.
...
```
{
    ...
    "rec_id": "LW_S3_20",
    "violationdescription": "Ensure the attached S3 bucket policy does not grant global List permission.",
    "eventuuid": "3d03e015-d70e-4f7b-a6db-d3e7ea68b299",
    "reportuuid": "77278938-72ec-49ab-a79c-959fd72b780f",
    ...
    "suppressionuuid": "63b092e0-5a50-46c2-b1b6-805cab11bdf1",
    "createbackup": "true",
...
1. Create a test S3 bucket that is violating the compliance rule for **LW_S3_20** via the CLI command described in the section [How can i use the Map?](https://github.com/automatecloud/lacework-kaholo-autoremediation/tree/main/maps/compliance/aws/LW_S3_20#how-can-i-use-this-map-for-auto-remediation)
...
export EVENTDESCRIPTION="AWS Account 112233445566 (lacework-test) : LW_S3_20 Ensure the attached S3 bucket policy does not grant 'List' permission to everyone"
export REC_ID=LW_S3_20
```
